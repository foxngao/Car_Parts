...
ALTER TABLE orders
  ADD COLUMN IF NOT EXISTS full_name NVARCHAR(255) DEFAULT NULL,
  ADD COLUMN IF NOT EXISTS phone VARCHAR(20) DEFAULT NULL,
  ADD COLUMN IF NOT EXISTS address NVARCHAR(500) DEFAULT NULL,
  ADD COLUMN IF NOT EXISTS notes NVARCHAR(1000) DEFAULT NULL;
